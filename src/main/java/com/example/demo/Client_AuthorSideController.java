...
public class Client_AuthorSideController {
    ...
    @FXML
    void initialize() {
        AddAuthor_Button.addEventHandler(MouseEvent.MOUSE_CLICKED, mouseEvent -> {
            AddAuthor_Button.getScene().getWindow().hide();
            Parent root = null;
            try {
                root = FXMLLoader.load(getClass().getResource("AddNewAuthor_Client.fxml"));
            } catch (Exception e) {
                e.printStackTrace();
            }
